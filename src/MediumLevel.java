...
public class MediumLevel extends Frame {
    ...
    public void launchFrame() {
        ...
        JLabel sredniNapis = new JLabel("Poziom Średni\n");
        ...
        for (int row = 0; row < ROWS; row++) {
            for (int col = 0; col < COLUMNS; col++) {
                ...
                if (row == 2 && col == 0 || row == 6 && col == 1 || row == 4 && col == 6) {
                ...
                cell.addMouseListener(new MouseAdapter() {
                    ...
                    final boolean warunek1 = (r == 0 && c == 0 || r == 0 && c == 1 || r == 0 && c == 2 ||
                            r == 0 && c == 3 || r == 0 && c == 4 || r == 0 && c == 5 || r == 0 && c == 8 ||
                            r == 1 && c == 0 || r == 1 && c == 5 || r == 1 && c == 6 || r == 1 && c == 7 ||
                            r == 1 && c == 8 || r == 2 && c == 1 || r == 2 && c == 2 || r == 2 && c == 3 ||
                            r == 2 && c == 6 || r == 2 && c == 8 || r == 3 && c == 3 || r == 3 && c == 4 ||
                            r == 3 && c == 5 || r == 3 && c == 6 || r == 3 && c == 8 || r == 4 && c == 0 ||
                            r == 4 && c == 1 || r == 4 && c == 2 || r == 4 && c == 3 || r == 4 && c == 5 ||
                            r == 4 && c == 8 || r == 5 && c == 1 || r == 5 && c == 3 || r == 5 && c == 6 ||
                            r == 5 && c == 7 || r == 5 && c == 8 || r == 6 && c == 0 || r == 6 && c == 4 ||
                            r == 6 && c == 5 || r == 6 && c == 6 || r == 6 && c == 8 || r == 7 && c == 0 ||
                            r == 7 && c == 1 || r == 7 && c == 2 || r == 7 && c == 3 || r == 7 && c == 8 ||
                            r == 8 && c == 3 || r == 8 && c == 4 || r == 8 && c == 5 || r == 8 && c == 6 ||
                            r == 8 && c == 7 || r == 8 && c == 8);
                    final boolean warunek2 = (r == 0 && c == 7 || r == 1 && c == 2 || r == 1 && c == 3 ||
                            r == 1 && c == 4 || r == 2 && c == 4 || r == 2 && c == 5 || r == 2 && c == 7 ||
                            r == 3 && c == 0 || r == 3 && c == 1 || r == 3 && c == 2 || r == 3 && c == 7 ||
                            r == 4 && c == 7 || r == 5 && c == 2 || r == 5 && c == 4 || r == 5 && c == 5 ||
                            r == 6 && c == 2 || r == 6 && c == 3 || r == 6 && c == 7 || r == 7 && c == 5 ||
                            r == 7 && c == 6 || r == 7 && c == 7 || r == 8 && c == 1 || r == 8 && c == 2);
        ...
        reset.addActionListener(resetClick -> {
            MediumLevel mediumLevelFrameGuiWindow = new MediumLevel();
            mediumLevelFrameGuiWindow.launchFrame();
            dispose();
        });
            ...
            for (int col = 0; col < COLUMNS; col++) {
                ...
                cell.addMouseListener(new MouseAdapter() {
                    ...
                    public void mouseClicked(MouseEvent e) {
                        ...
                        System.out.println("Suma finalna: " + finalSum);
                        System.out.println("Liczba błędów: " + mistakesNum);
                    }
                });
                p2.add(cell);
            }
